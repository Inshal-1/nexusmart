...
const Footer = () => {
    ...
    const GithubIcon = () => (<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#90A1B9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>)
    ...
    const linkSections = [
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "+92-333-4123452", path: '/', icon: PhoneIcon },
                { text: "inshalyousaf1@gmail.com", path: '/', icon: MailIcon },
                { text: "Pakistan", path: '/', icon: MapPinIcon }
            ]
        }
    ];
    ...
    const socialIcons = [
        ...
        { icon: LinkedinIcon, link: "https://linkedin.com/in/inshalyousaf" },
        { icon: GithubIcon, link: "https://github.com/Inshal-1" },
    ]
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                            <span className="text-cyan-500">Nexus</span>Mart<span className="text-cyan-500 text-5xl leading-0">.</span>
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to NexusMart, your ultimate destination for the latest and smartest gadgets. From smartphones and smartwatches to essential accessories, we bring you the best in innovation — all in one place.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © NexusMart All Right Reserved.
                </p>
            </div>
        </footer>
    );
